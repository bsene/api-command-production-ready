...
## Why `task load` excludes spike/throttle
...
A 429-dominated result confirms the `reservedConcurrency=5` guard is active
(throttled invocations do not bill). **0% 429 = guard inactive → investigate**
